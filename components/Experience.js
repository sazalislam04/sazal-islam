        ...
        <div className="relative wrap overflow-hidden p-10 h-full">
          ...
          <div className="mb-4 flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div className="order-1 bg-indigo-400 rounded-lg custom-shadow w-5/12 px-6 py-4">
              <h3 className="mb-3 font-bold flex justify-between items-center text-white text-xl">
                Complete Web Development
                <span className="text-xs bg-white text-indigo-800 px-2 rounded-full py-1">
                  Course
                </span>
              </h3>
              <p className="text-sm font-medium mb-2 leading-snug tracking-wide text-white text-opacity-100">
                Duration: 01 June 2022 to 01 December 2022
              </p>
          ...
          <div className="mb-4 flex justify-between items-center w-full right-timeline">
            ...
            <div className="order-1 bg-white rounded-lg custom-shadow w-5/12 px-6 py-4">
              ...
              <p className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100 capitalize">
                Company: Uptal (brand under Betterplus Technologies Pvt. Ltd)
              </p>
              <p className="text-sm leading-snug tracking-wide mt-2 text-gray-900 text-opacity-100 capitalize">
                Starting: 10th of December 2022 to continue
              </p>
              <p className="text-sm leading-snug tracking-wide mt-2 text-gray-900 text-opacity-100 capitalize">
                Location: Electronic city, Bangalore, IN
              </p>
            </div>
          </div>
